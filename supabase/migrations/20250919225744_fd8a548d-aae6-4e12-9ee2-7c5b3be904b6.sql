-- Create demo user and seed data for the AI dashboard
...
-- Adding more students for comprehensive demo data
...
-- Continue with more students to reach 50+
...
-- Add some academic performance records
INSERT INTO public.academic_performance (student_id, subject, test_type, test_date, score, max_score, percentage)
SELECT 
    s.id,
    subjects.subject,
    'Unit Test',
    ...
    100,
    floor(random() * 80) + 20 -- Percentage between 20-100
FROM students s
CROSS JOIN (
...
-- Create demo admin user profile (we'll handle auth user creation separately)
INSERT INTO public.profiles (user_id, first_name, last_name, role) VALUES
('00000000-0000-0000-0000-000000000000', 'Demo', 'Admin', 'admin')
ON CONFLICT (user_id) DO NOTHING;

-- Add some notifications for the demo
INSERT INTO public.notifications (recipient_id, type, title, message, priority, student_id)
SELECT 
    '00000000-0000-0000-0000-000000000000',
    'risk_alert',
    'High Risk Student Alert',
    'Student ' || s.student_id || ' requires immediate attention due to high dropout risk.',
