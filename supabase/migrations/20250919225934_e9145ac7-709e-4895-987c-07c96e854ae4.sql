-- Create demo user and seed data for the AI dashboard (fixed enum values)
...
-- Add some intervention records for at-risk students (using 'active' status)
